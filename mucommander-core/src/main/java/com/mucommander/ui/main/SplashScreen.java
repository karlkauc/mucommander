 ...
 * corner) and a loading message (in the lower left corner) which is updated by {@link com.mucommander.Application} to
 * show startup progress. It is then closed by {@link com.mucommander.Application} when muCommander is fully started and
 * ready for use.
 * </p>
 *
...
public class SplashScreen extends JWindow {
    ...
    private final static String SPLASH_IMAGE_PATH =
            IconManager.getIconSetFolder(IconManager.MUCOMMANDER_ICON_SET) + "splash.png";
    ...
    public void paint(Graphics g) {
        ...
        java.awt.geom.Rectangle2D textBounds =
                new java.awt.font.TextLayout(version, customFont, fontRenderContext).getBounds();
